...
program
    .version("0.1.0-beta6")
    .description("Command Line Interface for the LightPanel Panel");
...
program
    .command('createUser')
    .description('Creates a new Admin user for LightPanel')
    .action(async () => {
        const readline = require('readline');
        ...
        async function main() {
            log.init('create a new *admin* user for the LightPanel panel:')
